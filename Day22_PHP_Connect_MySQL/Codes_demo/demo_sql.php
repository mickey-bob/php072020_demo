...
// 9 - Truy van JOIN
<!--
Inner join: Return record mà matching values ở cả 2 tables.
vd:
SELECT Orders.OrderID, Customers.CustomerName
FROM Orders
INNER JOIN Customers ON Orders.CustomerID = Customers.CustomerID;
-- Matching value: CustomerID phải có ở cả table Order vs Customer
-- Left join: Nếu trong table Orders có 1 CustomerID mà taable customer ko có
thì record vẫn có CustomerID của table Orders, còn bên table customer sẽ cho ra giá trị NULL.
