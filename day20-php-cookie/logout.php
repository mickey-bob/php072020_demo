...
//// neu ko xoa cookie se ko log out dc, tai sao ve xem lai code. --> vi ko xoa cookie
/// thi header ve file: demologin.php, se co doan code check cookie, cookie ton tai thi
/// auto login.
